...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to cmGame website!\ncmGame is an open source game 'engine' that uses Windows's command prompt and allows you to make programs and games for it!\n\nType in 'cat download.txt' to download the latest version of cmGame\nType in 'cat examples.txt' to see some example programs\nType in 'cat about.txt' to read some more stuff\nType in 'cat changelog.txt' to check what's new in latest updates\nType in 'cat github.txt' to check cmGame's source code",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "download.txt": "https://example.com",
